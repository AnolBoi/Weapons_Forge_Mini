...
public class CustomStoneSwordItem extends BaseLevelableSwordItem {
    public CustomStoneSwordItem(Item.Properties properties) {
        super(Tiers.STONE, 0, -2.45F, properties);
    }

    protected int maxLevelStone = 1;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Current Level: " + itemLevel + "/" + maxLevelStone).withStyle(ChatFormatting.GRAY));
