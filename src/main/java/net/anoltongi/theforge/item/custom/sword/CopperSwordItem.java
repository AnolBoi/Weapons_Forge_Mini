...
public class CopperSwordItem extends BaseLevelableSwordItem{
    public CopperSwordItem(Item.Properties properties) {
        super(Tiers.STONE, 9, -2.45F, properties);
    }

    protected int maxLevelCopper = 5;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Current Level: " + itemLevel + "/" + maxLevelCopper).withStyle(ChatFormatting.GRAY));
