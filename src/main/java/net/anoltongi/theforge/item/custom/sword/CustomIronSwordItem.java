...
public class CustomIronSwordItem extends BaseLevelableSwordItem{
    public CustomIronSwordItem(Item.Properties properties) {
        super(Tiers.IRON, 9, -2.45F, properties);
    }

    protected int maxLevelIron = 5;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Current Level: " + itemLevel + "/" + maxLevelIron).withStyle(ChatFormatting.GRAY));
