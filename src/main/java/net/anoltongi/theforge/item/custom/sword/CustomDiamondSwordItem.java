...
public class CustomDiamondSwordItem extends BaseLevelableSwordItem{

    public CustomDiamondSwordItem(Properties properties) {
        super(Tiers.DIAMOND, 2, -2.4f, properties);
    }

    protected int maxLevelDiamond = 10;
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.literal("Current Level: " + itemLevel + "/" + maxLevelDiamond).withStyle(ChatFormatting.GRAY));
