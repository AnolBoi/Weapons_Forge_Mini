...
import net.anoltongi.weaponsforgemini.datagen.loot.ModBlockLootTables;
...
@Mod.EventBusSubscriber(modid = WeaponsForgeMiniMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
